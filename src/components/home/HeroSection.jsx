    ...
    <section id="home" className="relative flex w-full flex-col overflow-hidden bg-white text-gray-900 md:flex-row min-h-screen pt-20">
      ...
      <div className="flex w-full flex-col justify-center p-6 sm:p-8 md:w-1/2 md:p-12 lg:w-3/5 lg:p-16">
        ...
        <div>
          ...
          <main>
            <h1 
              className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900 transition-all duration-700 ease-out ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
              }`}
            ...
            <div 
              className={`my-4 md:my-6 h-1 w-16 md:w-20 bg-blue-600 transition-all duration-700 ease-out ${
            ...
            <p 
              className={`mb-6 md:mb-8 max-w-md text-sm sm:text-base text-gray-600 leading-relaxed transition-all duration-700 ease-out ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
              }`}
            ...
            >
              <a 
                ...
                className="inline-block text-base sm:text-lg font-bold tracking-widest text-blue-600 transition-all duration-300 hover:text-blue-800 hover:translate-x-2"
              >
                {callToAction.text}
              </a>
              <button 
                onClick={handleWhatsApp}
                className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 text-white rounded-full font-semibold text-base sm:text-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300"
              >
